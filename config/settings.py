...
ALLOWED_HOSTS = [
    ...
    ".ngrok-free.app",
    ".ngrok-free.dev",
    "matstorehaiti.online",
    "www.matstorehaiti.online",
    ".railway.app",
]
...
CSRF_TRUSTED_ORIGINS = [
    ...
    "https://matstorehaiti.online",
    "https://www.matstorehaiti.online",
    "https://*.railway.app",
]
...
JAZZMIN_SETTINGS = {
    ...
    "usermenu_links": [
        {"name": "Voir la boutique", "url": "/", "new_window": True, "icon": "fas fa-store"},
        {"model": "accounts.Customer"},
    ],
